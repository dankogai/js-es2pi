...
(function(root){
    ...
    describe('Array', function() {
        ...
        it ('Array.from({0:0,length.1})', 
            eq_deeply(Array.from({0:0,length:1}), [0]));
    });
    ...
    describe('Array.prototype.sorted', function () {
        ...
        it('a.sorted()',    eq_deeply(a.sorted(), 
                                      [1,127,15,255,3,31,63,7]));
        it('a.sorted(cmp)', eq_deeply(a.sorted(cmp), 
                                      [1,3,7,15,31,63,127,255]));
        it('a remains unchanged', eq_deeply(a, 
                                            [7,63,127,31,1,3,15,255]));
    });
})(this);
